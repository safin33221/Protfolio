        ...
        <div className="bg-[#251C31] text-white pb-5  min-h-screen overflow-x-hidden pt-16 md:pt-10">
            ...
            <div className="w-11/12 mx-auto grid md:grid-cols-2 gap-10">
                <div data-aos="fade-right"
                    data-aos-offset="100"
                >
                    <div className="  border-2 border-[#693B93] p-7 min-h-full rounded-lg">
                ...
                <div data-aos="fade-right"
                    data-aos-offset="150">
                    <div className="  border-2 border-[#693B93] p-7 min-h-full rounded-lg">
                        <h2 className=" text-2xl list-item"> My Coding Journey: From Paper to Programming Hero</h2>
                        <p className="text-gray-400">My coding journey began when I didn't have a device to practice on. I started learning HTML, CSS, and JavaScript by writing everything down in a notebook. After four months, thanks to my family's support, I got my first laptop. However, even with a device, I struggled to progress without proper guidance or a care team. At one point, I wanted to ask my family for money to pursue further learning, but our financial situation wasn't great. Determined, I began saving money for six months to invest in a course that could guide me. Finally, I was able to afford the Programming Hero Web Development course, which has been one of the best learning platforms in Bangladesh and has greatly helped me in my journey to becoming a web developer.</p>
                    </div>
                </div>
                <div data-aos="fade-left"
                    data-aos-offset="150">
